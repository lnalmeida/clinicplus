...
public class UpdateEspecialidadeValidator : AbstractValidator<UpdateEspecialidadeViewModel>
{
    public UpdateEspecialidadeValidator(ClinicPlusContext context)
    {
        RuleFor(e => e.Titulo)
        ...
        RuleFor(m => m)
            .Must(e => !context.Especialidades.Any(especialidade => especialidade.Cor == e.Cor && especialidade.Id != e.Id))
